...
def get_compositions(segmentation, motor_speeds, gcode, rasterSpeed, savepath, maxComp=100, minComp=0, bufferTimeStart=1,bufferTimeEnd=1, rasterScaleX=1, rasterScaleY=1, rasterOffsetX=0, rasterOffsetY=0,verbose=False):
    ####################
    # Motor Speed Data #
    ####################
    ...
    drops_m = cv2.dilate(segmentation.copy().astype('uint8'), np.ones((8, 8), np.uint8))
